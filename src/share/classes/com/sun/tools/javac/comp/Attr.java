 ...
 *************************************************************************/
    ...
    public void visitClassDef(JCClassDecl tree) {
        ...
        if (c == null) {
      	...
      	//add by ljs
      	//record the class symbol, which is used to map to its declaration
        //System.out.println("visitClassDef, RECORD-------------" + tree.sym);
        assert(tree.sym != null);
      	JavaCompiler.classSymbolInitMap.put(tree.sym, tree);
      	//end 
    }
...
//                             Resolve.isStatic(env));//DEBUG
    ...
    private void attribClassBody(Env<AttrContext> env, ClassSymbol c) {
        ...
        if (env.info.lint.isEnabled(LintCategory.SERIAL) &&
      	...
      	//add by ljs
      	//record the class symbol, which is used to map to its declaration
        //System.out.println("attribute class body,RECORD-------------" + tree.sym);
        assert(tree.sym != null);
      	JavaCompiler.classSymbolInitMap.put(tree.sym, tree);
